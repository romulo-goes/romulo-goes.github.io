...
<div class="bio">
	<div class = "row">
		<div class = "column left" style="margin-top: 4em;">	
			<div class = "contact"> 
				<p class="small" style="font-size:17px;text-align:center">Postdoctoral Researcher<br>
				<a href = "https://www.isri.cmu.edu/">Institute for Software Research</a>, Carnegie Mellon University<br>
				<a href = "https://ece.engin.umich.edu/">Electrical Engineering and Computer Science</a>, University of Michigan<br>
        Email: romulo [at] umich.edu
        </p>
      </div>
      <div class = "icons" style="margin-top: 1em;margin-left: 7em">
		...
		<div class = "column right">
			<div class = "img"><img src="/assets/images/rmg-2020.jpg" style="width:400px;height:396px;" class="rounded-corners"></div>
		</div>
	</div>
...
<div class= "News">
	<h2>Latest News</h2>
  <ul>
  <li>01/12/2021 - Our paper about robustness against sensor deception cyber-attacks is in press at the IEEE TAC journal</li>
  <li>01/01/2021 - I have started my postdoctoral at CMU</li>
  <li>10/30/2020 - I have succesfully defended my doctoral thesis</li>
  <li>07/15/2021 - Our paper about synthesis of sensor deception cyber-attacks is in press at Automatica</li>
</ul>
</div>
